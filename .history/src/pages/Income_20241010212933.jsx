                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className=" bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                                <form onSubmit={addIncome}>
                                    ...
                                    <input
                                        type='date'
                                        className='text-white w-full bg-transparent rounded-md border border-stroke dark:border-dark-3 py-[10px] px-5 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2'
                                    />
                                    <DatePicker />
