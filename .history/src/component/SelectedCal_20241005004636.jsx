...
const TdStyle = {
  ...
  TdStyle3: `text-dark border-b border-[#E8E8E8] bg-white dark:border-dark dark:bg-dark-4 dark:text-dark-7 py-5 px-2 text-center text-base font-medium`,
  TdButton: `inline-block px-6 py-2.5 border rounded-md border-primary text-primary hover:bg-primary hover:text-white font-medium`,
}

const SelectedCal = () => {
  return (
    <section className='bg-white dark:bg-dark py-5 lg:py-[120px] mb-[200px]'>
